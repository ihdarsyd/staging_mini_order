...
ALTER TABLE staging.category OWNER TO postgres;

--
-- Name: category_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE staging.category_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE staging.category_category_id_seq OWNER TO postgres;

--
-- Name: category_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE staging.category_category_id_seq OWNED BY staging.category.category_id;
...
CREATE SEQUENCE staging.customer_customer_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE staging.customer_customer_id_seq OWNER TO postgres;

--
-- Name: customer_customer_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE staging.customer_customer_id_seq OWNED BY staging.customer.customer_id;
...
ALTER TABLE staging.order_detail OWNER TO postgres;

--
-- Name: order_detail_order_detail_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE staging.order_detail_order_detail_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE staging.order_detail_order_detail_id_seq OWNER TO postgres;

--
-- Name: order_detail_order_detail_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE staging.order_detail_order_detail_id_seq OWNED BY staging.order_detail.order_detail_id;
...
ALTER TABLE staging.orders OWNER TO postgres;
...
ALTER TABLE staging.product OWNER TO postgres;
...
ALTER TABLE staging.subcategory OWNER TO postgres;

--
-- Name: subcategory_subcategory_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE staging.subcategory_subcategory_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE staging.subcategory_subcategory_id_seq OWNER TO postgres;

--
-- Name: subcategory_subcategory_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE staging.subcategory_subcategory_id_seq OWNED BY staging.subcategory.subcategory_id;
...
ALTER TABLE ONLY staging.category ALTER COLUMN category_id SET DEFAULT nextval('staging.category_category_id_seq'::regclass);
...
ALTER TABLE ONLY staging.customer ALTER COLUMN customer_id SET DEFAULT nextval('staging.customer_customer_id_seq'::regclass);
...
ALTER TABLE ONLY staging.order_detail ALTER COLUMN order_detail_id SET DEFAULT nextval('staging.order_detail_order_detail_id_seq'::regclass);
...
ALTER TABLE ONLY staging.subcategory ALTER COLUMN subcategory_id SET DEFAULT nextval('staging.subcategory_subcategory_id_seq'::regclass);
...
COPY staging.category (category_id, name, description, created_at, updated_at) FROM stdin;
...
COPY staging.customer (customer_id, first_name, last_name, email, phone, address, created_at, updated_at) FROM stdin;
...
COPY staging.order_detail (order_detail_id, order_id, product_id, quantity, price, created_at, updated_at) FROM stdin;
...
COPY staging.orders (order_id, customer_id, order_date, status, created_at, updated_at) FROM stdin;
...
COPY staging.product (product_id, name, subcategory_id, price, stock, created_at, updated_at) FROM stdin;
...
COPY staging.subcategory (subcategory_id, name, category_id, description, created_at, updated_at) FROM stdin;
...
SELECT pg_catalog.setval('staging.category_category_id_seq', 1, false);
...
SELECT pg_catalog.setval('staging.customer_customer_id_seq', 1, false);
...
SELECT pg_catalog.setval('staging.order_detail_order_detail_id_seq', 1, false);
...
SELECT pg_catalog.setval('staging.subcategory_subcategory_id_seq', 1, false);
...
ALTER TABLE ONLY staging.category
...
ALTER TABLE ONLY staging.order_detail
...
ALTER TABLE ONLY staging.product
...
ALTER TABLE ONLY staging.subcategory
...
ALTER TABLE ONLY staging.subcategory
    ADD CONSTRAINT fk_category FOREIGN KEY (category_id) REFERENCES staging.category(category_id);
...
ALTER TABLE ONLY staging.orders
    ADD CONSTRAINT fk_customer FOREIGN KEY (customer_id) REFERENCES staging.customer(customer_id);
...
ALTER TABLE ONLY staging.order_detail
    ADD CONSTRAINT fk_order FOREIGN KEY (order_id) REFERENCES staging.orders(order_id);
...
ALTER TABLE ONLY staging.order_detail
    ADD CONSTRAINT fk_product FOREIGN KEY (product_id) REFERENCES staging.product(product_id);
...
ALTER TABLE ONLY staging.product
    ADD CONSTRAINT fk_subcategory FOREIGN KEY (subcategory_id) REFERENCES staging.subcategory(subcategory_id);
...
ALTER TABLE ONLY staging.order_detail
    ADD CONSTRAINT order_detail_order_id_fkey FOREIGN KEY (order_id) REFERENCES staging.orders(order_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY staging.order_detail
    ADD CONSTRAINT order_detail_product_id_fkey FOREIGN KEY (product_id) REFERENCES staging.product(product_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY staging.orders
    ADD CONSTRAINT orders_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES staging.customer(customer_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY staging.product
    ADD CONSTRAINT product_subcategory_id_fkey FOREIGN KEY (subcategory_id) REFERENCES staging.subcategory(subcategory_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY staging.subcategory
    ADD CONSTRAINT subcategory_category_id_fkey FOREIGN KEY (category_id) REFERENCES staging.category(category_id) ON DELETE CASCADE;
